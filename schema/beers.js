  ...
  items: {
    ...
    properties: {
      ...
      target_fg: {
        type: "integer",
        enum: [
          1010, 1007, 1012, 1027, 1005, 1017, 1020, 1013, 1025, 1014, 1030,
          1000,
        ],
      },
      target_og: {
              ...
              properties: {
                temp: {
                  ...
                  properties: {
                    value: {
                      type: "integer",
                      enum: [64, 69, 60, 65, 72, 78, 66, 67, 68],
                    },
                    unit: {
                      type: "string",
                      enum: ["celsius"],
            ...
            properties: {
              temp: {
                ...
                properties: {
                  value: {
                    type: "integer",
                    enum: [19, 18, 21, 9, 10, 22, 11, 17, 20],
                  },
                  unit: {
                    type: "string",
                    enum: ["celsius"],
          ...
          hops: {
            ...
            items: {
              ...
              properties: {
                ...
                add: {
                  type: "string",
                  enum: ["start", "middle", "end", "dry hop"],
                },
                attribute: {
                  type: "string",
                  enum: ["bitter", "flavour", "aroma", "Flavour"],
                },
              },
      ...
      contributed_by: {
        type: "string",
        enum: ["Sam Mason <samjbmason>", "Ali Skinner <AliSkinner>"],
      },
    },
    required: [
      "id",
